...
class XT_XML_Metabox {
	...
	public $meta_key = 'xt_xml_description';
	...
	public function email_lede() {
		...
		echo '<textarea rows="1" columns="40" class="xt_xml_desc" id="' . $this->meta_key . '" name="' . $this->meta_key . '">' . esc_textarea($value) . '</textarea>';
